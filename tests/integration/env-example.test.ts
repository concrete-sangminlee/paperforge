...
describe('.env.example completeness', () => {
  ['DATABASE_URL','REDIS_URL','MINIO_ENDPOINT','MINIO_PORT','MINIO_ACCESS_KEY','MINIO_SECRET_KEY','MINIO_BUCKET',
   'AUTH_SECRET','NEXTAUTH_SECRET','NEXTAUTH_URL','SMTP_HOST','SMTP_PORT','SMTP_FROM','ENCRYPTION_KEY',
   'NEXT_PUBLIC_APP_URL','NEXT_PUBLIC_WS_URL','NEXT_PUBLIC_APP_NAME'].forEach(key => {
